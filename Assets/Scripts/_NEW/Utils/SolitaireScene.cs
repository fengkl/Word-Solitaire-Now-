        ...
        for (int i = 0; i < aimCount; i++)
        {
            ...
            foreach (string word in words)
            {
                ...
                if (characterCard.useSprite)
                {
                    ...
                    // 有精灵
                    string spritePath = "Sprites/t_word_" + word;
                    print("尝试加载精灵: " + spritePath);
    
                    characterCard.cardImage = Resources.Load<Image>(spritePath);
                    ...
                    if (characterCard.cardImage != null)
                    {
                        ...
                        print($"成功加载精灵: {spritePath}");
                    }
                    else
                    {
                        Debug.LogWarning($"找不到精灵资源: {spritePath}，使用文字显示");
