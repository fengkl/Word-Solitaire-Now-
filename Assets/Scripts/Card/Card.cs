...
public class Card : MonoBehaviour
{
    ...
    /// 移动牌面文字并变小
    /// </summary>
    public void MovingCardTextToSmall()
    {
        ...
        // 缩放和移动文字
        sequence.Join(cardCanvas.transform.DOScale(canvasScaleValue, moveDuration));
        sequence.Join(cardCanvas.transform.DOLocalMoveY(textMoveToYValue, moveDuration));
    }
    ...
    /// 移动牌位置
    /// </summary>
    public void MovingCardPos()
    {
        transform.DOLocalMoveY(cardMoveToYValue, moveDuration);
    }
    ...
    public void FlipCard()
    {
        ...
        sequence.Append(cardBackSr.transform.DOScaleX(0, flipDuration));
        sequence.Append(cardFront.transform.DOScaleX(1, flipDuration));
        sequence.AppendCallback(() =>
        {
            parent.GetComponent<CardGroup>().canSelected = true;
            // parent.GetComponent<CardGroup>().ChangeBoxColliderSize();
        });
    }
